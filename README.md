...
2. Click the green **Use this template** button (or **Fork** if you don't see that)
3. Give your copy a name like `wc2026-bot`
4. Make sure it's set to **Private** (so your keys stay safe)
